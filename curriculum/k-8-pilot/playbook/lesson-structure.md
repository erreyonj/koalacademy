...
Same spot every day: the first block of class, and the first callout on the portal lesson.

- **K–2:** Floor circle, not desks. Partner/talk prompts are allowed. Link a music
  fundamental to CREW / CRISP. Keep prompts KG-doable so the band can share one lesson page.
- **3–5 and 6–8:** One Do Now per band is enough — 3rd/4th/5th share, 6th/7th/8th share.
  Default for middle school is **silence**. Independent journal or listen-then-journal is
  the usual shape.
