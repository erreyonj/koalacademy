...
Eighth grade runs the Koalacademy curriculum closest to its original form — the course was
written with roughly this grade as its floor. The lens is *interpretive discourse: restraint
vs. complexity, artistic intent, and meaning* (see
...
- Differentiation from the 6th- and 7th-grade runs of the course — see
  [grade-6.md](grade-6.md) open questions.
- Whether 8th grade adds a capstone element beyond `PERFORMANCE.5` (public performance,
  school showcase) — TBD with admin.
