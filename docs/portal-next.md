...
> **Status: spec.** Nothing in this file is built yet. It records what to implement next on the
> student portal, in enough detail that a later pass can start without re-litigating the
> product decisions.

The original V1 proposal lives in
[curriculum/k-8-pilot/resources/portal-v1.md](../curriculum/k-8-pilot/resources/portal-v1.md).
That document scoped the lesson slide hub. The hub exists. This file is the next slice:
